    ...
    <div class="row">
      <form id="searchForm" class="form-horizontal span24">
		...
		<div class="control-group span8">
            <label class="control-label">总运单号</label>
            <div class="controls">
              <input type="text" class="control-text" name="id">
            </div>
          </div>
          <div class="control-group span8">
            <label class="control-label">航次航班号</label>
            <div class="controls">
              <input type="text" class="control-text" name="id">
            </div>
          </div>
          ...
          <div class="control-group span8">
            <label class="control-label">进出口状态</label>
            <div class="controls" >
		  ...
		  <div class="control-group span8">
		   ...
		   <div class="control-group span8">
            <label class="control-label">创建公司</label>
            <div class="controls">
        ...
        <div class="row">
		  ...
		  <div class="span3 offset2">
            <button  type="button" id="btnSearch" class="button button-primary">重置</button>
          </div>
        </div>
      </form>
    </div>
...
<script type="text/javascript">
  BUI.use('common/search',function (Search) {
    ...
    function addFunction(){
      window.location.href=<?php echo "'".site_url()."/waybill/waybill_add_add'";?>;
