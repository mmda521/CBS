...
<head>
    ...
    <link href="<?php echo base_url();?>/webroot/CBS_Platform/assets/css/page-min.css" rel="stylesheet" type="text/css" />
...
<body>
    <div class="container">
        <div class="row">
            ...
            <div class="span16">
                <img src="<?php echo base_url();?>/webroot/CBS_Platform/assets/images/table.jpg" />
                <br />
                <h2>
                    参数说明</h2>
                <p>
    ...
    <script type="text/javascript" src="../../../webroot/CBS_Platform/<?php echo base_url();?>/webroot/CBS_Platform/assets/js/prettify.js"></script>
    <script type="text/javascript">
        $(function () {
            prettyPrint();
        });
