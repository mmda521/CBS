...
<script type="text/javascript">
  ...
  var data=<?php echo json_encode($info);?>,
        grid = new Grid.SimpleGrid({
          ...
          width : 950,      //设置宽度
          columns : [
            {title:'学生编号',dataIndex:'UPDATEDATE',width:80},
            {title:'学生姓名',dataIndex:'UPDATEDATE',width:100},
            {title:'入学时间',dataIndex:'UPDATEDATE',width:100,renderer:Grid.Format.dateRenderer},
            {title:'学生家庭住址',dataIndex:'UPDATEDATE',width:300}
          ]
        });
      grid.render();
      grid.showData(data);
