...
<html>
 ...
 <body>
  ...
  <div class="container">
    <div class="row">
      <form id="searchForm" class="form-horizontal span24" action="<?php echo site_url();?>/sample/index">
        <div class="row">
          <div class="control-group span8">
            <label class="control-label">库位号：</label>
            <div class="controls">
              <input type="text" class="control-text" name="goodssite_no">
            </div>
          </div>
          <div class="control-group span8">
            <label class="control-label">库位说明：</label>
            <div class="controls">
  ...
  <div id="content" class="hide">
      <form id="J_Form" class="form-horizontal" action="edit.php?a=1">
        ...
        <div class="row">
          <div class="control-group span8">
            <label class="control-label"><s>*</s>库位姓名1</label>
            <div class="controls">
              <input name="name" type="text" data-rules="{required:true}" class="input-normal control-text">
            </div>
          </div>
          <div class="control-group span8">
            <label class="control-label"><s>*</s>库位状态：</label>
            <div class="controls">
        ...
        <div class="row">
          <div class="control-group span8">
            <label class="control-label"><s>*</s>库位班级</label>
            <div class="controls">
        ...
        <div class="row">
          <div class="control-group span15">
            <label class="control-label">库位家庭住址</label>
...
<script type="text/javascript">
  BUI.use('common/search',function (Search) {
    ...
    var enumObj = {"1":"男","0":"女"},
      ...
      columns = [
          {title:'检索号',dataIndex:'INDEX_NO',width:100},
          {title:'库位号',dataIndex:'GOODSSITE_NO',width:100},
          {title:'库位说明',dataIndex:'GOODSSITE_NOTE',width:100},
          {title:'操作人员',dataIndex:'OPERUSER_ID',width:100},
          {title:'操作时间',dataIndex:'OPERDATE',width:100},
          ...
          {title:'操作',dataIndex:'',width:200,renderer : function(value,obj){
            var editStr =  Search.createLink({ //链接使用 此方式
                ...
                title : '编辑库位信息',
                text : '打开编辑',
                href : <?php echo "'".site_url()."/sample/edit_open'";?>,
                target : '_self'
              }),
              editStr1 = '<span class="grid-command btn-edit" title="编辑库位信息">弹出编辑</span>',
              delStr = '<span class="grid-command btn-del" title="删除库位信息">删除</span>';//页面操作不需要使用Search.createLink
            return editStr +  editStr1 + delStr;
          }}
        ],
      store = Search.createStore(<?php echo "'".site_url()."/sample/xianshi'";?>,{
        proxy : {
