 ...
 <body>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="span16">
        <h2>图示</h2>
        <img src="<?php echo base_url();?>/webroot/CBS_Platform/assets/img/nav.jpg" alt="一级导航">
        <h2>代码</h2>
...
&lt;/ul&gt;            
    ...
    <div class="row">
      ...
      <div class="span16">
        ...
        <pre  class="prettyprint linenums">
.nav-home,.nav-step{
  background:url('<?php echo base_url();?>/webroot/CBS_Platform/img/nav_icon.png') no-repeat 0 0  transparent;
}
