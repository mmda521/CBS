  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="span16">
        <h3>示例</h3>
        <form id="J_Form3">
          <div class="bui-form-group-select" data-url="<?php echo base_url();?>/webroot/CBS_Platform/data/city.json">
            <label>省市联动：</label>
...
BUI.Form.Group.Select.addType('name',{
  proxy : {//加载数据的配置项
    url : 'http://..<?php echo base_url();?>/webroot/CBS_Platform/data/json',
    dataType : 'jsonp'//使用jsonp
  },
  map : {//由于返回数据源的数据信息跟定义的不一致
    isleaf : 'leaf', //将数据中的isleaf字段映射成leaf字段
