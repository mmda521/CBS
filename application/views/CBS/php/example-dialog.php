...
<html>
 ...
 <body>
  ...
  <div id="content" class="hide">
      <form id="J_Form" class="form-horizontal" action="<?php echo base_url();?>/webroot/CBS_Platform/data/edit.php?a=1">
      ...
      store = Search.createStore('<?php echo base_url();?>/webroot/CBS_Platform/data/student.json',{
        proxy : {
          save : { //也可以是一个字符串，那么增删改，都会往那么路径提交数据，同时附加参数saveType
            addUrl : '<?php echo base_url();?>/webroot/CBS_Platform/data/add.json',
            updateUrl : '<?php echo base_url();?>/webroot/CBS_Platform/data/edit.json',
            removeUrl : '<?php echo base_url();?>/webroot/CBS_Platform/data/del.php'
          }/*,
          method : 'POST'*/
        },
